...
import { Clients, Config, Invoices, Services } from "../../assets/svg/SvgIcons";
import { Navlink } from "../../components";
import { Loader } from "../../components";
import { Wrapper } from "../../containers";
import { Caption, LinksContainer, Title, ConfigBtn } from "./Home.styles";
    ...
    <Wrapper>
      <div>
        ...
        <HomeWrapper bgColor="white" style={{ padding: "70px", height: "80%" }}>
          ...
          <Caption>
            Please wait while we are importing your Stripe configurations. It
            will only <br />
